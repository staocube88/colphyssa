jQuery(document).ready(function($){
	...
	var conData					= { con_id: $conId.val(), action: 'adifier_ajax_conversations', adifier_nonce: adifier_data.adifier_nonce };
	...
	*/
	...
	function sendMessage( $this ){
		...
		formData.append( 'adifier_nonce', adifier_data.adifier_nonce );
