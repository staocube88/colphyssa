...
class CMB_Gmap_Field extends CMB_Field {
	...
	public function enqueue_scripts() {
		...
		if( $this->args['map_source'] == 'google' ){
			...
			wp_enqueue_script( 'cmb-maps', '//api.mapbox.com/mapbox-gl-js/v0.54.0/mapbox-gl.js', array(), false, true );
			wp_enqueue_style( 'cmb-mapbox', '//api.mapbox.com/mapbox-gl-js/v0.54.0/mapbox-gl.css' );
