...
function adifier_ext_term_save( $term_id ) {
	if( isset( $_POST['advert_cat_image'] ) ){
		update_term_meta( $term_id, 'advert_cat_image', sanitize_text_field( $_POST['advert_cat_image'] ) );
	}
	else{
		delete_term_meta( $term_id, 'advert_cat_image' );	
	}
	if( isset( $_POST['advert_cat_marker'] ) ){
		update_term_meta( $term_id, 'advert_cat_marker', sanitize_text_field( $_POST['advert_cat_marker'] ) );
	}
	else{
		delete_term_meta( $term_id, 'advert_cat_marker' );	
	}
	if( isset( $_POST['advert_cat_icon'] ) ){
		update_term_meta( $term_id, 'advert_cat_icon', sanitize_text_field( $_POST['advert_cat_icon'] ) );
	}
	else{
