...
// Don't duplicate me!
if ( ! class_exists( 'Redux_Extension_Grouped_Adifier', false ) ) {

	/**
	 * Class Redux_Extension_My_Extension
	 */
	class Redux_Extension_Grouped_Adifier extends Redux_Extension_Abstract {
		/**
		 ...
		 * @var string
		 */
		private $field_name = 'grouped_adifier';
		 ...
		 * @var string
		 */
		private $extension_name = 'Grouped Adifier';
		...
		public function __construct( $parent ) {
			...
			$this->add_field( 'grouped_adifier' );
		}
	}
}