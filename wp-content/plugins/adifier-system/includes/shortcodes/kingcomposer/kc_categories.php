						...
						<?php
							...
							if( !empty( $advert_cat_icon ) ){
								...
								<a href="<?php echo esc_url( get_term_link( $term ) ) ?>">
									<div class="category-icon" style="<?php echo !empty( $icon_margin ) ? esc_attr( 'margin-bottom: '.$icon_margin.';' ) : esc_attr(''); ?><?php echo !empty( $icon_max_width ) ? esc_attr( 'max-width: '.$icon_max_width ) : esc_attr( '' ); ?>"><?php echo adifier_get_category_icon_img( $advert_cat_icon ); ?></div>
								</a>
								<?php
							}
						?>
